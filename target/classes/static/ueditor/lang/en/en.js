...
UE.I18N['en'] = {
    ...
    'wordOverFlowMsg':'<span style="color:red;">The number of characters has exceeded allowable maximum values, the websocket may refuse to save!</span>',
    'ok':"OK",
    'cancel':"Cancel",
    'closeDialog':"closeDialog",
    'tableDrag':"You must import the file uiUtils.js before drag! ",
    'autofloatMsg':"The plugin AutoFloat depends on EditorUI!",
    'loadconfigError': 'Get websocket config error.',
    'loadconfigFormatError': 'Server config format error.',
    'loadconfigHttpError': 'Get websocket config http error.',
    'snapScreen_plugin':{
        'browserMsg':"Only IE supported!",
        'callBackErrorMsg':"The callback data is wrong,please check the config!",
        'uploadErrorMsg':"Upload error,please check your websocket environment! "
    },
    'insertcode':{
        'as3':'ActionScript 3',
        'bash':'Bash/Shell',
