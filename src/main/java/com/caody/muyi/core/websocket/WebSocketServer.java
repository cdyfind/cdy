package com.caody.muyi.core.websocket;


import com.caody.muyi.core.config.WebSocketConfig;
import com.caody.muyi.mogodb.Chat;
import com.caody.muyi.service.impl.MongodbService;
...
public class WebSocketServer {
    ...
    public void onMessage(String message, Session session) {
        ...
        Chat chat  = new Chat();
        chat.setUserSendId(sid);
        chat.setUserReceiveId(rsid);
